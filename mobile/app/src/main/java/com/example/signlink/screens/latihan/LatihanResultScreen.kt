...
fun LatihanResultScreen(
    ...
    val latihanId = result?.latihanId
    val totalChars = result?.totalQuestions ?: 0
    ...
    LaunchedEffect(result) {
        if (latihanId != null) {
            viewModel.addStatsLatihan(context, latihanId, averageSpeed)
        }
    }
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(20.dp)) {
                        ...
                        StatRow(
                            ...
                            value = "${"%.1f".format(averageSpeed).replace('.', ',')} detik/soal"
                        )
                    }
                }
